...
function unite_scripts() {
	...
	wp_enqueue_style( 'unite-bootstrap', get_template_directory_uri() . '/inc/css/bootstrap.min.css', array(), '3.4.1-1' );
	...
	wp_enqueue_script( 'unite-bootstrap', get_template_directory_uri() . '/inc/js/bootstrap.min.js', array( 'jquery' ), '3.4.1-1', true );
