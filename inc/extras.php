...
if ( ! function_exists( 'unite_sanitize_css_color' ) ) {
	/**
	 ...
	 */
	function unite_sanitize_css_color( $value ) {
		if ( ! is_string( $value ) ) {
			return '';
		}
...
if ( ! function_exists( 'unite_css_color' ) ) {
	/**
	 * Return a theme option as a CSS colour that is safe to print, or ''.
	 *
	 * Every colour printed into the inline <style> block goes through this.
	 * Options saved before the Customizer sanitiser was tightened may still hold
	 * arbitrary text, so the value is re-validated at output time rather than
	 * trusted from storage.
	 *
	 * @param string $name Option name.
	 * @return string Validated colour, or '' when the stored value is not one.
	 */
	function unite_css_color( $name ) {
		return unite_sanitize_css_color( unite_get_option( $name ) );
	}
}
 ...
 */
    function get_unite_theme_options(){
      ...
      if ( unite_css_color( 'link_color' )) {
        echo 'a, #infinite-handle span {color:' . unite_css_color( 'link_color' ) . '}';
      }
      if ( unite_css_color( 'link_hover_color' )) {
        echo 'a:hover, a:focus {color: '.unite_css_color( 'link_hover_color' ).';}';
      }
      if ( unite_css_color( 'link_active_color' )) {
        echo 'a:active {color: '.unite_css_color( 'link_active_color' ).';}';
      }
      if ( unite_css_color( 'element_color' )) {
        echo '.btn-primary, .label-primary, .carousel-caption h4 {background-color: '.unite_css_color( 'element_color' ).'; border-color: '.unite_css_color( 'element_color' ).';} hr.section-divider:after, .entry-meta .fa { color: '.unite_css_color( 'element_color' ).'}';
      }
      if ( unite_css_color( 'element_color_hover' )) {
		echo '.label-primary[href]:hover, .label-primary[href]:focus, #infinite-handle span:hover, #infinite-handle span:focus-within, .btn.btn-primary.read-more:hover, .btn.btn-primary.read-more:focus, .btn-primary:hover, .btn-primary:focus, .btn-primary:active, .btn-primary.active, .site-main [class*="navigation"] a:hover, .site-main [class*="navigation"] a:focus, .more-link:hover, .more-link:focus, #image-navigation .nav-previous a:hover, #image-navigation .nav-previous a:focus, #image-navigation .nav-next a:hover, #image-navigation .nav-next a:focus { background-color: '.unite_css_color( 'element_color_hover' ).'; border-color: '.unite_css_color( 'element_color_hover' ).'; }';
      }
      if ( unite_css_color( 'heading_color' )) {
        echo 'h1, h2, h3, h4, h5, h6, .h1, .h2, .h3, .h4, .h5, .h6, .entry-title {color: '.unite_css_color( 'heading_color' ).';}';
      }
      if ( unite_css_color( 'top_nav_bg_color' )) {
        echo '.navbar.navbar-default {background-color: '.unite_css_color( 'top_nav_bg_color' ).';}';
      }
      if ( unite_css_color( 'top_nav_link_color' )) {
        echo '.navbar-default .navbar-nav > li > a, .navbar-default .navbar-nav > .open > a, .navbar-default .navbar-nav > .open > a:hover, .navbar-default .navbar-nav > .open > a:focus, .navbar-default .navbar-nav > .active > a, .navbar-default .navbar-nav > .active > a:hover, .navbar-default .navbar-nav > .active > a:focus { color: '.unite_css_color( 'top_nav_link_color' ).';}';
      }
      if ( unite_css_color( 'top_nav_dropdown_bg' )) {
        echo '.dropdown-menu, .dropdown-menu > .active > a, .dropdown-menu > .active > a:hover, .dropdown-menu > .active > a:focus {background-color: '.unite_css_color( 'top_nav_dropdown_bg' ).';}';
      }
      if ( unite_css_color( 'top_nav_dropdown_item' )) {
        echo '.navbar-default .navbar-nav .open .dropdown-menu > li > a { color: '.unite_css_color( 'top_nav_dropdown_item' ).';}';
      }
      if ( unite_css_color( 'footer_bg_color' )) {
        echo '#colophon {background-color: '.unite_css_color( 'footer_bg_color' ).';}';
      }
      if ( unite_css_color( 'footer_text_color' )) {
        echo '.copyright {color: '.unite_css_color( 'footer_text_color' ).';}';
      }
      if ( unite_css_color( 'footer_link_color' )) {
        echo '.site-info a {color: '.unite_css_color( 'footer_link_color' ).';}';
      }
      if ( unite_css_color( 'social_color' )) {
        echo '.social-icons li a {color: '.unite_css_color( 'social_color' ).' !important;}';
      }
      $typography = unite_get_option('main_body_typography');
      if ( $typography ) {
        echo '.entry-content {font-family: ' . esc_attr( $typography['face'] ) . '; font-size:' . esc_attr( $typography['size'] ) . '; font-weight: ' . esc_attr( $typography['style'] ) . '; color:' . unite_sanitize_css_color( $typography['color'] ) . ';}';
      }
       ...
       */
      echo wp_strip_all_tags( unite_get_option( 'custom_css', '' ) );
      }
        echo '</style>';
    }
}
...
if (!function_exists('get_unite_theme_options'))  {
  function get_unite_theme_options(){
    ...
    if ( unite_css_color( 'element_color' )) {
      echo '.btn-default, .label-default, .flex-caption h2, .navbar-default .navbar-nav > .active > a, .navbar-default .navbar-nav > .active > a:hover, .navbar-default .navbar-nav > .active > a:focus, .navbar-default .navbar-nav > li > a:hover, .navbar-default .navbar-nav > li > a:focus, .navbar-default .navbar-nav > .open > a, .navbar-default .navbar-nav > .open > a:hover, .navbar-default .navbar-nav > .open > a:focus, .dropdown-menu > li > a:hover, .dropdown-menu > li > a:focus, .navbar-default .navbar-nav .open .dropdown-menu > li > a:hover, .navbar-default .navbar-nav .open .dropdown-menu > li > a:focus, .dropdown-menu > .active > a, .navbar-default .navbar-nav .open .dropdown-menu > .active > a {background-color: '.unite_css_color( 'element_color' ).'; border-color: '.unite_css_color( 'element_color' ).';} .btn.btn-default.read-more, .entry-meta .fa, .site-main [class*="navigation"] a, .more-link { color: '.unite_css_color( 'element_color' ).'}';
    }
    if ( unite_css_color( 'element_color_hover' )) {
	  echo '.label-default[href]:hover, .label-default[href]:focus, #infinite-handle span:hover, #infinite-handle span:focus-within, .btn.btn-default.read-more:hover, .btn.btn-default.read-more:focus, .btn-default:hover, .btn-default:focus, .scroll-to-top:hover, .scroll-to-top:focus, .btn-default:focus, .btn-default:active, .btn-default.active, .site-main [class*="navigation"] a:hover, .site-main [class*="navigation"] a:focus, .more-link:hover, .more-link:focus, #image-navigation .nav-previous a:hover, #image-navigation .nav-previous a:focus, #image-navigation .nav-next a:hover, #image-navigation .nav-next a:focus { background-color: '.unite_css_color( 'element_color_hover' ).'; border-color: '.unite_css_color( 'element_color_hover' ).'; }';
    }
    if ( unite_css_color( 'cfa_bg_color' )) {
      echo '.cfa { background-color: '.unite_css_color( 'cfa_bg_color' ).'; } .cfa-button:hover {color: '.unite_css_color( 'cfa_bg_color' ).';}';
    }
    if ( unite_css_color( 'cfa_color' )) {
      echo '.cfa-text { color: '.unite_css_color( 'cfa_color' ).';}';
    }
    if ( unite_css_color( 'cfa_btn_color' )) {
      echo '.cfa-button {border-color: '.unite_css_color( 'cfa_btn_color' ).';}';
    }
    if ( unite_css_color( 'cfa_btn_txt_color' )) {
      echo '.cfa-button {color: '.unite_css_color( 'cfa_btn_txt_color' ).';}';
    }
    if ( unite_css_color( 'heading_color' )) {
      echo 'h1, h2, h3, h4, h5, h6, .h1, .h2, .h3, .h4, .h5, .h6, .entry-title {color: '.unite_css_color( 'heading_color' ).';}';
    }
    ...
    if ( unite_css_color( 'top_nav_link_color' )) {
      echo '.navbar-default .navbar-nav > li > a { color: '.unite_css_color( 'top_nav_link_color' ).';}';
    }
    if ( unite_css_color( 'top_nav_dropdown_bg' )) {
      echo '.dropdown-menu, .dropdown-menu > .active > a, .dropdown-menu > .active > a:hover, .dropdown-menu > .active > a:focus {background-color: '.unite_css_color( 'top_nav_dropdown_bg' ).';}';
    }
    ...
    if ( unite_css_color( 'footer_text_color' )) {
      echo '#footer-area, .site-info {color: '.unite_css_color( 'footer_text_color' ).';}';
    }
    if ( unite_css_color( 'footer_widget_bg_color' )) {
      echo '#footer-area {background-color: '.unite_css_color( 'footer_widget_bg_color' ).';}';
    }
    if ( unite_css_color( 'footer_link_color' )) {
      echo '.site-info a, #footer-area a {color: '.unite_css_color( 'footer_link_color' ).';}';
    }
    if ( unite_css_color( 'social_color' )) {
      echo '.social-icons ul a {color: '.unite_css_color( 'social_color' ).' !important ;}';
    }
